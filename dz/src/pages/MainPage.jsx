                ...
                {Object.entries(jsonData.organizatoriFestivala).map(([key, item]) => {
                    return (
                        <Link className='relative z-20' to={`/org/${key}`} key={key}>
                            <div className='text-white transition-colors hover:bg-slate-500/50 bg-slate-500/20 rounded-md rounded-b-none backdrop-blur-lg relative border-b h-32' key={key}>
